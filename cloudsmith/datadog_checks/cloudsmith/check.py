...
class CloudsmithCheck(AgentCheck):
    ...
    def get_parsed_usage_info(self):
        ...
        storage_plan_limit_gb = round(storage_plan_limit_bytes * 1000 / (1024**4), 2) if storage_plan_limit_bytes != -1 else -1
        ...
        storage_configured_gb = round(storage_configured_bytes * 1000 / (1024**4), 2) if storage_configured_bytes != -1 else -1
